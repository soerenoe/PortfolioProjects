...
--Looking at turnover rate (specific for this particular dataset - counting non-nulls and calculating non_null_Hired/non_null_Terminated)
--WITH DateCounts AS (
--    SELECT 
...
--Looking at the most common reasons for quitting - improvement potentials
